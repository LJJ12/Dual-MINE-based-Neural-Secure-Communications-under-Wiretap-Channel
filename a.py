#b.py是对44.PDF的实现，a.py是将b.py改成我的方法
# -*- coding: utf-8 -*-
import numpy as np
% matplotlib inline
...
def train_Secure(kmeans_labels, NN_estimation0,NN_estimation1, n_epochs, n_steps, alpha, learning_rate=0.001):
    optimizer_mi0 = keras.optimizers.Nadam(lr=learning_rate)
    optimizer_mi1 = keras.optimizers.Nadam(lr=0.005)
...
train_mi(score_fn0,score_fn1, n_epochs=5, n_steps=500, batch_size=64, learning_rate=0.001)
train_Secure(kmeans.labels_, score_fn0,score_fn1, n_epochs, n_steps, 0.22, learning_rate=0.001)
test_encoding(M, 1)
